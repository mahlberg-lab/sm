---
title: "19C quotes vs. long suspensions"
...
```{r body_parts_19C_quotes_vs_long_sus_lexical, fig.width = 10, fig.height = 10, dpi=300}
plot(results)
```
...
```{r B1_19C_quotes_vs_long_sus_lexical, fig.width = 10, fig.height = 20, dpi=300}
plot(results)
```
...
```{r B1_19C_quotes_vs_long_sus_semantic, fig.width = 10, fig.height = 10, dpi=300}
plot(results)
```
