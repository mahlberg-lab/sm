---
title: "ChiLit quotes vs. non-quotes"
...
```{r body_parts_ChiLit_quotes_vs_non_quotes_lexical, fig.width = 10, fig.height = 30, dpi=300}
plot(results)
```
...
```{r B1_ChiLit_quotes_vs_non_quotes_lexical, fig.width = 10, fig.height = 60, dpi=300}
...
```{r B1_ChiLit_quotes_vs_non_quotes_semantic, fig.width = 10, fig.height = 25, dpi=300}
plot(results)
```
