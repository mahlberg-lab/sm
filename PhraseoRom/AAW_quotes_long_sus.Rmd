---
title: "AAW quotes vs. long suspensions"
...
```{r body_parts_AAW_quotes_vs_long_sus_lexical, fig.width = 10, fig.height = 4, dpi=300}
plot(results)
```
...
```{r B1_AAW_quotes_vs_long_sus_lexical, fig.width = 10, fig.height = 10, dpi=300}
plot(results)
```
...
```{r B1_AAW_quotes_vs_long_sus_semantic, fig.width = 10, fig.height = 5, dpi=300}
plot(results)
```
