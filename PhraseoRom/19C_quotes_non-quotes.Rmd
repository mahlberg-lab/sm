---
title: "19C quotes vs. non-quotes"
...
```{r body_parts_19C_quotes_vs_non_quotes_lexical, fig.width = 10, fig.height = 30, dpi=300}
plot(results)
```

```{r eyes_19C_quotes_vs_non_quotes_lexical, fig.width = 10, fig.height = 10, dpi=300}
plot(results[x=="eyes"])
```
...
```{r B1_19C_quotes_vs_non_quotes_lexical, fig.width = 10, fig.height = 100, dpi=300}
...
```{r B1_19C_quotes_vs_non_quotes_semantic, fig.width = 10, fig.height = 35, dpi=300}
plot(results)
```
